...
function openWordPopup(button){
 ...
 if(typeof ct==='function')$('#wordPopup').insertAdjacentHTML('beforeend',`<button type="button" id="savePersonalStory" class="btn secondary">${ct('saveStory')}</button>`);
